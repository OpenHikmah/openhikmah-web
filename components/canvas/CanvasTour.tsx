...
const STEPS = [
  { icon: Search, titleKey: "tourStep1Title", bodyKey: "tourStep1Body" },
  { icon: Network, titleKey: "tourStep2Title", bodyKey: "tourStep2Body" },
  { icon: MessageSquareText, titleKey: "tourStep3Title", bodyKey: "tourStep3Body" },
] as const;
